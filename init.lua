...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>nf', '<cmd>Neotree focus filesystem left<CR>', { desc = 'Neotree FileSystem' })
      vim.keymap.set('n', '<leader>nb', '<cmd>Neotree focus buffers left<CR>', { desc = 'Neotree Buffers' })
